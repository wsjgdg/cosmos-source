...
// Real quasars from Milliquas (VizieR VII/280) via astroquery + China-VO mirror.
// Generated by public/cosmos/gen_quasars.py — real RA/Dec/z; l/b and comoving
// distance derived with astropy/Planck18. Imported by cosmos-views.ts L6.
export { QUASARS_REAL } from './quasars-real';
